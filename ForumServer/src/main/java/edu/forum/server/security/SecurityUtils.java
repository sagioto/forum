...
public class SecurityUtils {
	...
	public static boolean isAuthorizedToPost(Controller controller, Post current, User User) throws RemoteException {
		return controller.getUsers().get(User.getUsername()).getLevel() != AuthorizationLevel.GUEST;
	}
